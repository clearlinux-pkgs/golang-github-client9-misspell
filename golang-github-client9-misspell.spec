...
%files
%defattr(-,root,root,-)
/usr/lib/golang/src/cmd/genwords/additions.go
/usr/lib/golang/src/cmd/genwords/american.go
/usr/lib/golang/src/cmd/genwords/delimit.go
/usr/lib/golang/src/cmd/genwords/main.go
/usr/lib/golang/src/cmd/genwords/wikipedia.go
/usr/lib/golang/src/cmd/misspell/main.go
/usr/lib/golang/src/falsepositives_test.go
/usr/lib/golang/src/replace.go
/usr/lib/golang/src/replace_test.go
/usr/lib/golang/src/words.go
